...
describe('Campaigns', () => {
  ...
  it('processes requests', async () => {
    ...
    let requestValue = await campaign.methods.requests(0).call();
    requestValue = String(requestValue.value);
    requestValue = parseFloat(web3.utils.fromWei(requestValue, 'ether'));

    assert.equal(requestValue, difference);
  });
});
